      ...
      <div className="home">
        <Navbar />
          ...
          <section className="hero">
              ...
              <p className="subtitle">Roomify is an AI-first design environment, that helps you visualize, render and ship architectural project faster then ever</p>
